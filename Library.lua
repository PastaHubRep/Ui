...
local Library = {
    ...
    --// Rainbow UI \\--
    RainbowHue = 0,
    -- Fixed pastel pink accent (no rainbow cycling)
    RainbowColor = Color3.fromRGB(255, 170, 200),
...
table.insert(Library.Signals, RunService.RenderStepped:Connect(function(Delta)
    ...
    -- Keep the accent/outline color fixed pastel pink instead of cycling through the rainbow.
    Library.RainbowColor = Color3.fromRGB(255, 170, 200)
